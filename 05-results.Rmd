...
```{r, fig.width=20, echo=FALSE, results='hide', message=FALSE}

ggparcoord(housedata, columns = 4:8, alphaLines = .3,scale = "uniminmax") + facet_wrap("Year") + theme(axis.text.x=element_text(angle=45, hjust=1)) + labs(title = "Paralellel Coordinates of Key Economic Variables", subtitle = '2010 - 2019')
...
```{r, fig.height=15, echo=FALSE, results='hide', message=FALSE}
...
```{r, fig.height=10, echo=FALSE, results='hide', message=FALSE}
